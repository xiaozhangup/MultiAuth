...
import cn.jason31416.multiauth.util.RSAUtil;
...
public class UniAuthAPIClient {
    ...
    public static String fetchPublicKey(boolean forceReload){
        File file = new File(MultiAuth.instance.getDataDirectory(), "publickey.txt");
        ...
        try {
            ...
            try {
                ...
                if(!pk.equals(pkey)){
                    ...
                    try(FileOutputStream fos = new FileOutputStream(new File(MultiAuth.instance.getDataDirectory(), "security-alert-"+new Date()+".txt"))){
